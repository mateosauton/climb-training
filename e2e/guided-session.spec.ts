...
async function openPlan(page: Page) {
  ...
  const mobilePlan = page.getByRole("tab", { name: "Plan" });
  if (await mobilePlan.isVisible().catch(() => false)) await mobilePlan.click();
  else await page.getByRole("button", { name: "Plan" }).click();
